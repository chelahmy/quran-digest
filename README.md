...
It is a fixed-length 256-bit hash as the result of double SHA-256 digesting on every verse in the digital Quran as the leaf nodes and every node in the Merkle tree.
